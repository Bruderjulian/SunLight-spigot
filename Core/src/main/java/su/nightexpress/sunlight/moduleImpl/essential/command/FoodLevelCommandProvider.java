...
public class FoodLevelCommandProvider extends CommandProvider {
        ...
        private void builderMode(LiteralNodeBuilder builder, ModifyMode mode) {
                ...
                builder
                                ...
                                .withArguments(Arguments.integer(CommandArguments.AMOUNT, 0)
                                                ...
                                                .suggestions((reader, context) -> IntStream.range(0, 21).boxed()
                ...
                return this.loadPlayerOrSenderAndRunInMainThread(context, arguments, this.module, this.userManager,
                                target -> {
                                        ...
                                        if (target != context.getSender()) {
                                                this.module.sendPrefixed(infoMessage, context.getSender(),
                                                                builder -> builder
                                        ...
                                        if (this.settings.foodSaturationEnabled.get()) {
                                                target.setSaturation(Math.min(MAX_VALUE,
                                                                target.getSaturation()
                                                                                + this.settings.foodSaturationAmount
                                                                                                .get().floatValue()));
                                        }

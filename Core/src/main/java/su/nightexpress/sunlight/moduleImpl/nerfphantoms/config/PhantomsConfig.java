...
public class PhantomsConfig {
        ...
        public static final ConfigValue<Set<CreatureSpawnEvent.SpawnReason>> DISABLE_SPAWN_REASONS = ConfigValue.forSet(
                        "DisableSpawn.Sources",
                        raw -> Utils.enumValueOf(raw, CreatureSpawnEvent.SpawnReason.class),

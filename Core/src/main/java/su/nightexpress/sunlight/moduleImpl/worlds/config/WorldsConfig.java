package su.nightexpress.sunlight.moduleImpl.worlds.config;
...
import su.nightexpress.sunlight.moduleImpl.worlds.util.Placeholders;
...
public class WorldsConfig {
        ...
        public static final Set<InventoryType> INVENTORY_SPLIT_TYPES = Set.of(InventoryType.PLAYER,
        ...
        public static final ConfigValue<Set<InventoryType>> INVENTORY_SPLIT_INVENTORIES = ConfigValue.forSet(
                        "Inventory_Split.Affected_Inventories",
                        ...
                        "Allowed values: " + INVENTORY_SPLIT_TYPES.stream().map(Enum::name)
                                        .collect(Collectors.joining(", ")));

        public static final ConfigValue<Map<String, Set<String>>> INVENTORY_SPLIT_WORLD_GROUPS = ConfigValue.forMap(
                        "Inventory_Split.World_Groups",
        ...
        public static final ConfigValue<Map<String, Set<String>>> COMMAND_BLOCKER_COMMANDS = ConfigValue.forMap(
                        "Command_Blocker.World_Commands",
                        ...
                        "This setting can be bypassed with the '" + WorldsPerms.BYPASS_COMMANDS.getName()
                                        + "' permission.");

        public static final ConfigValue<Set<String>> NO_FLY_WORLDS = ConfigValue.create("NoFlyWorlds",
                        Lists.newSet("world1", "world2"),
                        "List of worlds where players can not fly without the '" + WorldsPerms.BYPASS_FLY.getName()
                                        + "' permission.");

        public static final ConfigValue<Boolean> AUTO_RESET_NOTIFICATION_ENABLED = ConfigValue.create(
                        "AutoWipe.Notification.Enabled",
                        true,
                        "Sets whether or not players will get a notification about an upcoming world auto-reset.");

        public static final ConfigValue<Long> AUTO_RESET_NOTIFICATION_THRESHOLD = ConfigValue.create(
                        "AutoWipe.Notification.Threshold",
                        86400L,
        ...
        public static final ConfigValue<Long> AUTO_RESET_NOTIFICATION_INTERVAL = ConfigValue.create(
                        "AutoWipe.Notification.Interval",
                        3600L,
                        "Sets world's auto-reset notifications interval (in seconds).",
                        "[Default is 3600 (1 hour)]");

        public static final ConfigValue<Boolean> UNLOAD_MOVE_PLAYERS_TO_SPAWN_ENABLED = ConfigValue.create(
                        "AutoWipe.MovePlayersOut.ToSpawn.Enabled",
                        true,
        ...
        public static final ConfigValue<String> UNLOAD_MOVE_PLAYERS_TO_SPAWN_NAME = ConfigValue.create(
                        "AutoWipe.MovePlayersOut.ToSpawn.Name",
        ...
        public static boolean isInventoryAffected(InventoryType inventoryType) {

...
public class SpawnersLang implements LangContainer {
    ...
    public static final TextLocale COMMAND_SPAWNER_DESC = LangEntry.builder("Command.Spawner.Desc")
            .text("Change spawner type.");
    ...
    public static final MessageLocale COMMAND_SPAWNER_ERROR_TYPE = LangEntry.builder("Command.Spawner.Error.Type")
            .chatMessage(
                    GRAY.wrap("This type can not be set for spawner."));

    public static final MessageLocale COMMAND_SPAWNER_ERROR_BLOCK = LangEntry.builder("Command.Spawner.Error.Block")
            .chatMessage(

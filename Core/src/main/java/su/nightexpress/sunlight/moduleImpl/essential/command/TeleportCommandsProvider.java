...
public class TeleportCommandsProvider extends CommandProvider {
        ...
        public TeleportCommandsProvider(SunLightPlugin plugin, EssentialModule module, UserManager userManager,
        ...
        public void registerDefaults() {
                this.registerLiteral(COMMAND_LOCATION, true, new String[] { "coords", "tppos", "tploc" },
                                builder -> builder
                                                .description(DESCRIPTION_LOCATION)
                                                .permission(PERMISSION_LOCATION)
                                                .withArguments(
                                                                Arguments.integer(CommandArguments.X)
                                                                                .localized(Lang.COMMAND_ARGUMENT_NAME_X)
                                                                                .suggestions((reader,
                                                                                                context) -> getTabLocation(
                                                                                                                context,
                                                                                                                Block::getX)),
                                                                Arguments.integer(CommandArguments.Y)
                                                                                .localized(Lang.COMMAND_ARGUMENT_NAME_Y)
                                                                                .suggestions((reader,
                                                                                                context) -> getTabLocation(
                                                                                                                context,
                                                                                                                Block::getY)),
                                                                Arguments.integer(CommandArguments.Z)
                                                                ...
                                                                Arguments.playerName(CommandArguments.PLAYER)
                                                                                .permission(PERMISSION_LOCATION_OTHERS)
                                                                                .optional())
                ...
                this.registerLiteral(COMMAND_MOVE, true, new String[] { "move", "tpplayer" }, builder -> builder
                                ...
                                .withArguments(
                                                ...
                                                Arguments.playerName(CommandArguments.TARGET)
                                                                .localized(Lang.COMMAND_ARGUMENT_NAME_TARGET))
                                .withFlags(CommandArguments.FLAG_SILENT)
                                .executes(this::movePlayerToOther));

                this.registerLiteral(COMMAND_BRING, true, new String[] { "bring", "tphere", "movehere" },
                                builder -> builder
                                                .playerOnly()
                ...
                this.registerLiteral(COMMAND_TOP, true, new String[] { "surface", "tptop", "movetop" },
                                builder -> builder
        ...
        private List<String> getTabLocation(CommandContext context, Function<Block, Integer> function) {
        ...
        private boolean teleportToCoords(CommandContext context, ParsedArguments arguments) {
                                                        ...
                                                        .callback(() -> {
                                                                if (context.getSender() != target) {
                                                                        this.module.sendPrefixed(
                                                                                        MESSAGE_COORDS_FEEDBACK,
                                                                                        context.getSender(),
                                                                                        replacer -> replacer
                                                                                                        .with(CommonPlaceholders.PLAYER
                                                                                                                        .resolver(target))
                                                                                                        .with(CommonPlaceholders.LOCATION
                                                                                                                        .resolver(location)));
                                                                }

                                                                if (!context.hasFlag(CommandArguments.FLAG_SILENT)) {
                                                                        this.module.sendPrefixed(MESSAGE_COORDS_NOTIFY,
                                                                                        target,
                                                                                        replacer -> replacer.with(
                                                                                                        CommonPlaceholders.LOCATION
                                                                                                                        .resolver(location)));
                                                                }
                                                        })
                                                        .build();
        ...
        private boolean movePlayerToOther(CommandContext context, ParsedArguments arguments) {
                ...
                this.loadPlayerAndRunInMainThread(context, targetName, this.module, this.userManager, target -> {
                        ...
                        this.loadPlayerAndRunInMainThread(context, arguments, this.module, this.userManager,
                                        toPlayer -> {
                                                ...
                                                TeleportContext teleportContext = TeleportContext
                                                                ...
                                                                .callback(() -> {
                                                                        ...
                                                                        if (!context.hasFlag(
                                                                                        CommandArguments.FLAG_SILENT)) {
                                                                                this.module.sendPrefixed(
                                                                                                MESSAGE_MOVE_NOTIFY,
                                                                                                toPlayer,
                                                                                                replacer -> replacer
                                                                                                                .with(
                                                                                                                                CommonPlaceholders.PLAYER
                                                                                                                                                .resolver(target)));
                                                                        }
                                                                })
                                                                .build();
        ...
        private boolean summonPlayer(CommandContext context, ParsedArguments arguments) {
                ...
                return this.loadPlayerAndRunInMainThread(context, arguments, this.module, this.userManager, target -> {
                        ...
                        TeleportContext teleportContext = TeleportContext.builder(this.module, target, location)
                                        ...
                                        .withFlag(TeleportFlag.LOOK_FOR_SURFACE)
                                        .callback(() -> {
                                                this.module.sendPrefixed(MESSAGE_SUMMON_FEEDBACK, context.getSender(),
                                                                replacer -> replacer.with(
                                                                                CommonPlaceholders.PLAYER
                                                                                                .resolver(target)));
        ...
        private boolean teleportToPlayer(CommandContext context, ParsedArguments arguments) {
        ...
        private boolean teleportToTop(CommandContext context, ParsedArguments arguments) {
                return this.loadPlayerOrSenderAndRunInMainThread(context, arguments, this.module, this.userManager,
                                target -> {
                                        Block block = target.getWorld().getHighestBlockAt(target.getLocation())
                                        ...
                                        TeleportContext teleportContext = TeleportContext
                                                        ...
                                                        .callback(() -> {
                                                                ...
                                                                if (!context.hasFlag(CommandArguments.FLAG_SILENT)) {
                                                                        this.module.sendPrefixed(MESSAGE_SURFACE_NOTIFY,
                                                                                        target);
                                                                }
                                                        })
                                                        .build();

...
public class SpyCommandProvider extends AbstractCommandProvider {
        ...
        public void registerDefaults() {
                this.registerLiteral("logger", true, new String[] { "spylogger" }, builder -> builder
                                ...
                                .executes((context, arguments) -> this.toggleLogger(context, arguments,
                                                ToggleMode.TOGGLE)));
        ...
        private void builderMode(LiteralNodeBuilder builder, SpyType spyType, ToggleMode mode) {
                ...
                builder
                                ...
                                .withArguments(Arguments.playerName(CommandArguments.PLAYER)
                                                .permission(permissionOthers).optional())
                                .withFlags(CommandArguments.FLAG_SILENT)
                                .executes((context, arguments) -> this.toggleMode(context, arguments, spyType, mode));
        }

        private boolean toggleMode(CommandContext context, ParsedArguments arguments, SpyType spyType,
                        ToggleMode mode) {
                return this.loadPlayerOrSenderWithDataAndRunInMainThread(context, arguments, this.module,
                                ...
                                (user, target) -> {
                                        ...
                                        if (context.getSender() != target) {
                                                this.module.sendPrefixed(ChatLang.SPY_MODE_TOGGLE_FEEDBACK,
                                                                context.getSender(),
                                                                replacer -> replacer
                                        ...
                                        if (!context.hasFlag(CommandArguments.FLAG_SILENT)) {
                                                this.module.sendPrefixed(ChatLang.SPY_MODE_TOGGLE_NOTIFY, target,
                                                                replacer -> replacer
                                                                                .with(SLPlaceholders.GENERIC_TYPE,
                                                                                                () -> ChatLang.SPY_TYPE
                                                                                                                .getLocalized(spyType))
        ...
        private boolean toggleLogger(CommandContext context, ParsedArguments arguments, ToggleMode mode) {
                ...
                return this.loadPlayerOrSenderWithDataAndRunInMainThread(context, arguments, this.module,
                                ...
                                (user, target) -> {
                                        ...
                                        this.module.sendPrefixed(ChatLang.SPY_LOGGER_TOGGLE_FEEDBACK,
                                                        context.getSender(),
                                                        replacer -> replacer
                                                                        .with(CommonPlaceholders.PLAYER
                                                                                        .resolver(target))

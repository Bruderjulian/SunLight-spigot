...
public class PlayerWarpsMainMenu extends AbstractMenu implements LangContainer {
        ...
        private static final IconLocale ICON_FEATURED_WARP = LangEntry
                        .iconBuilder("PlayerWarps.UI.MainMenu.FeaturedWarp")
                ...
                this.addDefaultButton("view_all", MenuItem.builder()
                                .defaultState(ItemState.defaultBuilder()
                                                ...
                                                .displayModifier((context, item) -> item.replace(builder -> builder
                                                                .with(GENERIC_AMOUNT, () -> NumberUtil.format(
                                                                                this.module.getRepository().size()))))
        ...
        protected void onLoad(FileConfig config) {
                ...
                this.featuredIcon = ConfigProperty.of(ConfigTypes.NIGHT_ITEM, "Featured.Icon", NightItem
                                ...
                                .setLore(Lists.newList(
                                                GRAY.wrap("Purchase this slot for "
                                                                + YELLOW.wrap(PlayerWarpsPlaceholders.SLOT_PRICE)
                                                                + " to"),
                                                GRAY.wrap("feature your warp for "
                                                                + WHITE.wrap(PlayerWarpsPlaceholders.SLOT_DURATION)
                                                                + "!"),
                                                "",
                                                ...
                                                .defaultState(ItemState.defaultBuilder()
                                                                .icon(this.featuredIcon.copy()
                                                                                .replace(builder -> builder.with(
                                                                                                slot.placeholders())))
                                                                .action(context -> this.module.openFeaturingDialog(
                                                                                context.getPlayer(), slot,
                                                                                slotIndex))
                                                                .build())
                                                .slots(inventorySlot)
                                                .build());

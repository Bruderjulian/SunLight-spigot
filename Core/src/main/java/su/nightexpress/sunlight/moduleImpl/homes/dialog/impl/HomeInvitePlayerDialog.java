package su.nightexpress.sunlight.moduleImpl.homes.dialog.impl;
...
public class HomeInvitePlayerDialog extends Dialog<Home> {
    ...
    public HomeInvitePlayerDialog(SunLightPlugin plugin, HomesModule module, UserManager userManager) {
        this.plugin = plugin;
        this.module = module;

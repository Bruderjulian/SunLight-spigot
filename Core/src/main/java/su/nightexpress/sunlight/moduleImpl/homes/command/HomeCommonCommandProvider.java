...
public class HomeCommonCommandProvider extends CommandProvider {
    ...
    public HomeCommonCommandProvider(SunLightPlugin plugin, HomesModule module, UserManager userManager) {
        super(plugin);
        this.module = module;
    ...
    public void registerDefaults() {
        ...
        this.registerRoot("homes", true, new String[] { "homes" },
                ...
                builder -> builder.description(HomesLang.COMMAND_HOMES_ROOT_DESC)
                        .permission(HomesPerms.COMMAND_HOMES_ROOT));
    }
    ...
    private ArgumentNodeBuilder<Home> homeArgument(boolean ofPlayer) {
        return Commands.argument(ARG_HOME, (context, string) -> Optional.of(ofPlayer ? context.getArguments().getString(
                ...
                .suggestions((reader, context) -> {
                    ...
                    String ownerName = ofPlayer ? context.getArguments().getString(CommandArguments.PLAYER)
                            : player
                                    .getName();
    ...
    private Home getHomeOrDefault(Player player, ParsedArguments arguments,
    ...
    private boolean listHomes(CommandContext context, ParsedArguments arguments) {
        Player player = context.getPlayerOrThrow();
    ...
    private boolean setHome(CommandContext context, ParsedArguments arguments) {
        Player player = context.getPlayerOrThrow();
    ...
    private boolean teleportToHome(CommandContext context, ParsedArguments arguments) {
        Player player = context.getPlayerOrThrow();
        Home home = this.getHomeOrDefault(player, arguments, context);
        if (home == null)
            return false;
    ...
    private boolean visitHome(CommandContext context, ParsedArguments arguments) {
        Player player = context.getPlayerOrThrow();
    ...
    private boolean inviteHome(CommandContext context, ParsedArguments arguments) {
        Player player = context.getPlayerOrThrow();

package su.nightexpress.sunlight.moduleImpl.scheduler;
...
public class SchedulerDefaults {
        ...
        public static Map<String, Announcer> getDefaultAnnouncers() {
                ...
                texts.put("discord", List.of(
                                ...
                                DARK_GRAY.wrap(BOLD.wrap("|")) + " "
                                                + GRAY.wrap("Stay up to date with all " + BLUE.wrap("announcements")
                                                                + ", "),
                                DARK_GRAY.wrap(BOLD.wrap("|")) + " "
                                                + GRAY.wrap(BLUE.wrap("giveaways") + ", " + BLUE.wrap("events")
                                                                + " and much more!"),
                                " ",
                ...
                texts.put("vote", List.of(
                                ...
                                DARK_GRAY.wrap(BOLD.wrap("|")) + " "
                                                + GRAY.wrap("Don't forget to " + GREEN.wrap("vote") + " for our"),
                                DARK_GRAY.wrap(BOLD.wrap("|")) + " "
                                                + GRAY.wrap("server daily for " + GREEN.wrap("free rewards") + "."),
                                " ",
                ...
                texts.put("store", List.of(
                                ...
                                DARK_GRAY.wrap(BOLD.wrap("|")) + " "
                                                + GRAY.wrap("Obtain " + ORANGE.wrap("crate keys")
                                                                + " for an opportunity to"),
                                DARK_GRAY.wrap(BOLD.wrap("|")) + " "
                                                + GRAY.wrap("acquire " + ORANGE.wrap("exciting rewards")
                                                                + " within the game."),
                                " ",

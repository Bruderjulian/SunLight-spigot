...
import static su.nightexpress.sunlight.moduleImpl.kits.KitsPlaceholders.KIT_ID;
    ...
    public void defineDefaultLayout() {
        ...
        this.addDefaultButton("create", MenuItem.button()
                .defaultState(ItemState.builder()
                        ...
                        .action(context -> {
                            this.plugin.showDialog(context.getPlayer(), KitDialogKeys.KIT_CREATION, this.module,
                                    () -> context
                                            .getViewer().refresh());
                        })
                        .build())

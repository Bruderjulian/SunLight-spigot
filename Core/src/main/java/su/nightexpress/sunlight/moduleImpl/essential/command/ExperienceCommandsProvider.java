                ...
                builder
                                ...
                                .withArguments(
                                                ...
                                                Arguments.playerName(CommandArguments.PLAYER)
                                                                .permission(PERMISSION_LEVEL_OTHERS).optional())
                                ...
                                .withArguments(
                                                Arguments.integer(CommandArguments.AMOUNT)
                                                                .localized(CoreLang.COMMAND_ARGUMENT_NAME_AMOUNT
                                                                                .text()),
                                                Arguments.playerName(CommandArguments.PLAYER)
                                                                .permission(PERMISSION_XP_OTHERS).optional())
                                .withFlags(CommandArguments.FLAG_SILENT)
                                ...
                                target -> {
                                        ...
                                        if (!context.hasFlag(CommandArguments.FLAG_SILENT)) {
                                                this.module.sendPrefixed(notifyMessage, target, builder -> builder
                                                                ...
                                                                .with(GENERIC_NEW_VALUE, () -> NumberUtil
                                                                                .format(target.getTotalExperience())));
                                        }
                                });
        }
                                ...
                                target -> {
                                        ...
                                        if (!context.hasFlag(CommandArguments.FLAG_SILENT)) {
                                                this.module.sendPrefixed(notifyMessage, target, builder -> builder
                                                                .with(GENERIC_VALUE, () -> NumberUtil.format(amount))
                                                                .with(GENERIC_OLD_VALUE,
                                                                                () -> NumberUtil.format(oldLevel))
                                                                .with(GENERIC_NEW_VALUE, () -> NumberUtil
                                                                                .format(target.getLevel())));
                                        }
                                });
        }
}

package su.nightexpress.sunlight.moduleImpl.spawns.dialog.impl;
    ...
    public WrappedDialog create(Player player, Spawn spawn) {
        return Dialogs.builder()
                .base(DialogBases.builder(TITLE)
                        ...
                        .inputs(
                                DialogInputs.bool(JSON_ENABLED, INPUT_ENABLED)
                                        .initial(this.ruleFunction.apply(spawn).isEnabled())
                                        .build(),

...
import static su.nightexpress.sunlight.moduleImpl.chat.ChatPlaceholders.CHANNEL_NAME;
import static su.nightexpress.sunlight.moduleImpl.chat.ChatPlaceholders.ITEM_NAME;
import static su.nightexpress.sunlight.moduleImpl.chat.ChatPlaceholders.ITEM_VALUE;
...
import su.nightexpress.sunlight.moduleImpl.chat.ChatFiles;
import su.nightexpress.sunlight.moduleImpl.chat.format.FormatComponent;
...
public class ChatSettings extends AbstractConfig {
        ...
        private final ConfigProperty<String> roleplayMeFormat = this.addProperty(ConfigTypes.STRING,
                        ...
                        ITALIC.wrap(SOFT_AQUA.wrap(PLAYER_DISPLAY_NAME) + " "
                                        + GRAY.wrap(SLPlaceholders.GENERIC_MESSAGE)),
        ...
        private final ConfigProperty<String> formatFallback = this.addProperty(ConfigTypes.STRING,
        ...
        private final ConfigProperty<Boolean> channelsEnabled = this.addProperty(ConfigTypes.BOOLEAN,
                        "Channels.Enabled",
                        true,
        ...
        private final ConfigProperty<String> channelsDefaultId = this.addProperty(ConfigTypes.STRING,
                        ...
                        "[*] If invalid channel provided, fallbacks to the %s channel."
                                        .formatted(ChatDefaults.DEFAULT_CHANNEL_ID));
        ...
        private final ConfigProperty<String> conversationIncomingFormat = this.addProperty(ConfigTypes.STRING,
                        ...
                        LIGHT_PURPLE.wrap("[Whisper]") + " " + SOFT_PINK.wrap(PLAYER_DISPLAY_NAME + ": ") + GRAY.wrap(
                                        ...
                                        SUGGEST_COMMAND.with("/" + ChatDefaults.DEFAULT_PM_ALIAS + " " + PLAYER_NAME)
                                                        .wrap(
                                                                        SHOW_TEXT.with(LIGHT_PURPLE
                                                                                        .wrap("Click to reply!"))
                                                                                        .wrap(LIGHT_PURPLE
                                                                                                        .wrap("[⬅]"))),
        ...
        private final ConfigProperty<String> conversationOutgoingFormat = this.addProperty(ConfigTypes.STRING,
                        ...
                        LIGHT_PURPLE.wrap("[Whisper]") + " " + SOFT_PINK.wrap("You ➡ " + PLAYER_DISPLAY_NAME + ": ")
                                        + GRAY.wrap(
                                                        SLPlaceholders.GENERIC_FORMAT),
        ...
        private final ConfigProperty<String> mailFormat = this.addProperty(ConfigTypes.STRING, "Mail.Format",
                        ...
                        "- " + PLAYER_DISPLAY_NAME
                                        + " - Sender display (custom) name. Falls back to the sender name for offline senders.",
                        "- " + SLPlaceholders.GENERIC_MESSAGE + " - Mail message.");

        private final ConfigProperty<Boolean> mentionsEnabled = this.addProperty(ConfigTypes.BOOLEAN,
                        "Mentions.Enabled",
                        true,
        ...
        private final ConfigProperty<String> mentionsFormat = this.addProperty(ConfigTypes.STRING,
                        "Mentions.Player.Format",
        ...
        private final ConfigProperty<Set<String>> profanityFilterRules = this.addProperty(
        ...
        private final ConfigProperty<Boolean> itemShowEnabled = this.addProperty(ConfigTypes.BOOLEAN,
                        "ItemShow.Enabled",
                        true,
        ...
        private final ConfigProperty<Map<SpyType, String>> spyFormat = this.addProperty(
                        ...
                        "- %s - Target player name (for %s mode only).".formatted(GENERIC_TARGET,
                                        SpyType.SOCIAL.name()),
        ...
        public boolean isAntiCapsBlacklistedCommand(String command) {
        ...
        public boolean isAntiFloodWhitelistedCommand(String command) {
        ...
        public String getSpyModeFormat(SpyType type) {
                return this.spyFormat.get().get(type);
        }

        public boolean isProfanityFilterAffectedCommand(String command) {
                return this.isCommandInList(command, this.profanityFilterAffectedCommands.get());
        }

        private boolean isCommandInList(String command, Collection<String> collection) {

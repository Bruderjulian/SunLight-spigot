...
public class WarmupsConfig {
    ...
    public static final ConfigValue<Set<TeleportType>> TELEPORT_HANDLED_TYPES = ConfigValue.forSet(
            "Teleport.HandledTypes",
    ...
    public static final ConfigValue<IntRankMap> TELEPORT_WARMUPS_BY_RANK = ConfigValue.create(
            "Teleport.Warmups_By_Rank",
            IntRankMap::read,
    ...
    public static final ConfigValue<String> BAR_INDICATOR_TELEPORT_TITLE = ConfigValue.create(
            "BarIndicator.Teleport.Title",
            WHITE.wrap("Teleporting in " + GREEN.wrap(GENERIC_TIME + "s")),
            "Sets warmup indicator title for teleport warmups.");

    public static final ConfigValue<NightBarColor> BAR_INDICATOR_TELEPORT_COLOR = ConfigValue.create(
            "BarIndicator.Teleport.Color",
            NightBarColor.class, NightBarColor.GREEN,
            "Sets warmup indicator color for teleport warmups.");

    public static final ConfigValue<NightBarOverlay> BAR_INDICATOR_TELEPORT_STYLE = ConfigValue.create(
            "BarIndicator.Teleport.Style",

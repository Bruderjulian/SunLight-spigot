...
public class NametagsSettings extends AbstractConfig {
        ...
        private final ConfigProperty<Long> nametagUpdateInterval = this.addProperty(ConfigTypes.LONG,
        ...
        private final ConfigProperty<Map<String, NameTagFormat>> nametagFormats = this.addProperty(
                        ConfigTypes.forMapWithLowerKeys(NAME_TAG_FORMAT_CONFIG_TYPE),
                        "Nametags.Groups",

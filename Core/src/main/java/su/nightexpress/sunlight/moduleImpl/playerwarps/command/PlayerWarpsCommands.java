...
public class PlayerWarpsCommands extends CommandProvider {
    ...
    public PlayerWarpsCommands(SunLightPlugin plugin, PlayerWarpsModule module, UserManager userManager) {
        super(plugin);
        this.module = module;
    ...
    private ArgumentNodeBuilder<PlayerWarp> warpArgument(BiFunction<Player, PlayerWarp, Boolean> suggestions) {
        return this.warpArgument(null, suggestions);
    }

    private ArgumentNodeBuilder<PlayerWarp> warpArgument(Predicate<PlayerWarp> predicate,
            BiFunction<Player, PlayerWarp, Boolean> suggestions) {
    ...
    private boolean moveToWarp(CommandContext context, ParsedArguments arguments) {

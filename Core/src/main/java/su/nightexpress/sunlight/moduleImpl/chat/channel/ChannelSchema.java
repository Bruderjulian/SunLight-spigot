...
import static su.nightexpress.sunlight.moduleImpl.chat.ChatPlaceholders.*;

public class ChannelSchema {

        public static final ConfigProperty<String> NAME = ConfigProperty.of(ConfigTypes.STRING, "Name", "Channel",
        ...
        public static final ConfigProperty<Boolean> PERMISSION_TO_LISTEN = ConfigProperty.of(ConfigTypes.BOOLEAN,
                        "Permission_Required.Hear",
                        false,
                        "If enabled, only players with the channel permission are able to read and join this channel.");

        public static final ConfigProperty<Boolean> PERMISSION_TO_SPEAK = ConfigProperty.of(ConfigTypes.BOOLEAN,
                        "Permission_Required.Speak",
                        false,
                        "If enabled, only players with the channel permission are able to speak in this channel.");

        public static final String DEFAULT_COOLDOWN_MESSAGE = GRAY
                        .wrap("Please wait " + ORANGE.wrap(SLPlaceholders.GENERIC_TIME)
                                        + " before send another message.");

        public static final ConfigProperty<IntRankMap> MESSAGE_COOLDOWN = ConfigProperty.of(
                        ConfigType.of(ChannelSchema::readCooldowns,
                                        (FileConfig config, String path, IntRankMap map) -> map.write(config, path)),
                        "Message_Cooldown",
                        IntRankMap.ranked(1),
        ...
        public static final ConfigProperty<String> MESSAGE_COOLDOWN_MESSAGE = ConfigProperty.of(ConfigTypes.STRING,
                        "Message_Cooldown_Message",
        ...
        public static final ConfigProperty<ChannelDistanceType> DISTANCE_TYPE = ConfigProperty.of(
                        ConfigTypes.forEnum(ChannelDistanceType.class), "Distance.Type",
                        ChannelDistanceType.SERVER_WIDE,
                        "Channel distance mode.",
                        "[>] Available Values: [ %s ]".formatted(Enums.inline(ChannelDistanceType.class)));

        public static final ConfigProperty<Double> DISTANCE_RANGE = ConfigProperty.of(ConfigTypes.DOUBLE,
                        "Distance.Range",
                        -1D,
        ...
        public static final ConfigProperty<Boolean> COMMAND_ENABLED = ConfigProperty.of(ConfigTypes.BOOLEAN,
                        "Command.Enabled",
                        true,
                        "If enabled, adds a dedicated one-shot channel command for players to join the channel.");

        public static final ConfigProperty<String> COMMAND_ALIAS = ConfigProperty.of(ConfigTypes.STRING,
                        "Command.Alias",
                        "",
                        "Channel command alias.");

        public static final ConfigProperty<Boolean> PREFIX_ENABLED = ConfigProperty.of(ConfigTypes.BOOLEAN,
                        "Prefix.Enabled",
                        true,
        ...
        private static IntRankMap readCooldowns(FileConfig config, String path) {
                int legacy = config.getInt(path, -1);
                if (legacy >= 0)
                        return IntRankMap.ranked(legacy);
        ...
        public static List<ChatChannel> getDefaultChannels() {
                ...
                channels.add(ChatChannel.create(ChatDefaults.DEFAULT_LOCAL_CHANNEL_ID,
                                ...
                                new ChannelAccessibility(true, false, false, IntRankMap.ranked(1),
                                                DEFAULT_COOLDOWN_MESSAGE),
                ...
                channels.add(ChatChannel.create("world",
                                ...
                                new ChannelAccessibility(true, false, false, IntRankMap.ranked(3),
                                                DEFAULT_COOLDOWN_MESSAGE),
                ...
                channels.add(ChatChannel.create("trade",
                                ...
                                new ChannelAccessibility(true, false, true, IntRankMap.ranked(30),
                                                DEFAULT_COOLDOWN_MESSAGE),
                                new ChannelDistance(ChannelDistanceType.SERVER_WIDE, -1),
                ...
                channels.add(ChatChannel.create(
                                ...
                                new ChannelAccessibility(true, true, true, IntRankMap.ranked(0),
                                                DEFAULT_COOLDOWN_MESSAGE),
                                new ChannelDistance(ChannelDistanceType.SERVER_WIDE, -1),
        ...
        public static ChatChannel createDefaultChannel() {
                return ChatChannel.create(
                                ...
                                new ChannelAccessibility(true, false, false, IntRankMap.ranked(0),
                                                DEFAULT_COOLDOWN_MESSAGE),
                                new ChannelDistance(ChannelDistanceType.SERVER_WIDE, -1),

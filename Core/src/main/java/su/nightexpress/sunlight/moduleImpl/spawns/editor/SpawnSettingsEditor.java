...
import static su.nightexpress.sunlight.moduleImpl.spawns.SpawnsPlaceholders.SPAWN_WORLD;
import static su.nightexpress.sunlight.moduleImpl.spawns.SpawnsPlaceholders.SPAWN_X;
import static su.nightexpress.sunlight.moduleImpl.spawns.SpawnsPlaceholders.SPAWN_Y;
import static su.nightexpress.sunlight.moduleImpl.spawns.SpawnsPlaceholders.SPAWN_Z;
...
public class SpawnSettingsEditor extends AbstractObjectMenu<Spawn> implements LangContainer {
    ...
    private static final IconLocale ICON_LOCATION = LangEntry.iconBuilder("Spawns.Editor.Spawn.Location")
            ...
            .appendCurrent("Current",
                    RED.wrap(SPAWN_X) + ", " + GREEN.wrap(SPAWN_Y) + ", " + BLUE.wrap(SPAWN_Z) + " @ " +
                            WHITE.wrap(SPAWN_WORLD))
            .br()
    ...
    public void defineDefaultLayout() {
        ...
        this.addDefaultButton("name", MenuItem.button()
                .defaultState(ItemState.builder()
                        ...
                        .action(context -> {
                            this.plugin.showDialog(context.getPlayer(), SpawnsDialogKeys.SPAWN_NAME,
                ...
                .defaultState(ItemState.builder()
                        ...
                        .displayModifier((context, item) -> item.replace(builder -> builder
                                .with(SLPlaceholders.GENERIC_STATE,
                                        () -> CoreLang.STATE_ENABLED_DISALBED.get(this.getObject(
                ...
                .defaultState(ItemState.builder()
                        ...
                        .displayModifier((context, item) -> item.replace(builder -> builder
                                .with(SLPlaceholders.GENERIC_VALUE,
                                        () -> String.valueOf(this.getObject(context).getPriority()))))
                        .action(context -> {
        ...
        this.addDefaultButton("login_rules", MenuItem.button()
                .defaultState(ItemState.builder()
                        ...
                        .action(context -> {
                            this.plugin.showDialog(context.getPlayer(), SpawnsDialogKeys.SPAWN_LOGIN_RULES,
                                    this.getObject(
                                            context),
                                    () -> context.getViewer().refresh());
                        })
        ...
        this.addDefaultButton("respawn_rules", MenuItem.button()
                .defaultState(ItemState.builder()
                        ...
                        .action(context -> {
                            this.plugin.showDialog(context.getPlayer(), SpawnsDialogKeys.SPAWN_RESPAWN_RULES,
                                    this.getObject(
                                            context),
                                    () -> context.getViewer().refresh());
                        })

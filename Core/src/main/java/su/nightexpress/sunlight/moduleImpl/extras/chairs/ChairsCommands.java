...
public class ChairsCommands extends AbstractCommandProvider {
    ...
    public void registerDefaults() {
        this.registerLiteral("chairs", true, new String[] { "chairs" }, builder -> builder
                ...
                .withArguments(Arguments.playerName(CommandArguments.PLAYER)
                        .permission(ExtrasPerms.COMMAND_CHAIRS_OTHERS).optional())
    ...
    private boolean toggleChairs(CommandContext context, ParsedArguments arguments, ToggleMode mode) {
        // TODO
        /*
         * return this.loadPlayerOrSenderWithDataAndRunInMainThread(context, arguments,
         * this.manager, this.userManager, (user, target) -> {
    ...
    private boolean sit(CommandContext context, ParsedArguments arguments) {
         ...
         * if (block.isEmpty() || !block.getType().isSolid()) block =

...
public class NickCommandProvider extends AbstractCommandProvider {
    ...
    public void registerDefaults() {
        ...
        this.registerRoot("nickname", true, new String[]{"nickname"},
            Map.of(
                ...
                COMMAND_CLEAR, "clear",
                COMMAND_SET, "set"),
            builder -> builder.description(NickLang.COMMAND_NICK_ROOT_DESC).permission(NickPerms.COMMAND_NICK_ROOT));
    }

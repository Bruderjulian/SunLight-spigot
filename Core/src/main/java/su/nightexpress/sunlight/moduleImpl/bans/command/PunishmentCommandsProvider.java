...
public class PunishmentCommandsProvider extends CommandProvider {
        ...
        public PunishmentCommandsProvider(SunLightPlugin plugin, BansModule module, UserManager userManager) {
                ...
                this.timeUnitArgumentType = (builder, string) -> Optional.ofNullable(module.getTimeUnitByAlias(string))
                                .orElseThrow(() -> CommandSyntaxException
                                                .custom(BansLang.COMMAND_SYNTAX_INVALID_TIME_UNIT));

                this.punishmentReasonArgumentType = (builder, string) -> Optional
                                .ofNullable(this.module.getReasonById(string))
                                .orElseThrow(() -> CommandSyntaxException
                                                .custom(BansLang.COMMAND_SYNTAX_INVALID_REASON));
        }
        ...
        private void buildPunishment(LiteralNodeBuilder builder, PunishmentType type, boolean isPermament) {
                ...
                builder
                                ...
                                .withFlags(CommandArguments.FLAG_SILENT)
                                .executes((context, arguments) -> this.punishPlayer(context, arguments, type,
                                                isPermament));
                ...
                if (isPermament) {
                        ...
                        builder.withArguments(
                                        ...
                                        Arguments.integer(CommandArguments.AMOUNT, 1)
                                                        ...
                                                        .suggestions((reader, context) -> List.of("1", "10", "30",
                                                                        "60")),

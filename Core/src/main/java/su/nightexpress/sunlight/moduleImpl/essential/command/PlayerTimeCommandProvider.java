...
public class PlayerTimeCommandProvider extends AbstractCommandProvider {
        ...
        private static final Permission PERMISSION_SET_OTHERS = EssentialPerms.COMMAND
                        .permission("playertime.set.others");
        ...
        private static final MessageLocale MESSAGE_RESET_FEEDBACK = LangEntry
                        .builder("Command.Time.Personal.Reset.Target")
                        .chatMessage(
                                        GRAY.wrap("You have reset " + SOFT_YELLOW.wrap(PLAYER_DISPLAY_NAME)
                                                        + "'s time."));

        private static final MessageLocale MESSAGE_RESET_NOTIFY = LangEntry
                        .builder("Command.Time.Personal.Reset.Notify")
                        .chatMessage(
        ...
        public void registerDefaults() {
                        ...
                        this.registerLiteral(name, false, new String[] { "p" + name }, builder -> builder
                                        ...
                                        .withArguments(
                                                        Arguments.playerName(CommandArguments.PLAYER)
                                                                        .permission(PERMISSION_SET_OTHERS).optional())
                ...
                this.registerLiteral(COMMAND_RESET, false, new String[] { "resetplayertime" }, builder -> builder
                                ...
                                .withArguments(
                                                Arguments.playerName(CommandArguments.PLAYER)
                                                                .permission(PERMISSION_RESET_OTHERS).optional())
                                .withFlags(CommandArguments.FLAG_SILENT)
                                .executes(this::clearPlayerTime));

                this.registerRoot("Player Time", true, new String[] { "playertime", "ptime" }, rootChildrens,
                                builder -> builder

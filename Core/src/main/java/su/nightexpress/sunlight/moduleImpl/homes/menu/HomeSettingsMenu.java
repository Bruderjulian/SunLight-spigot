package su.nightexpress.sunlight.moduleImpl.homes.menu;
...
import static su.nightexpress.sunlight.moduleImpl.homes.HomePlaceholders.HOME_FAVORITE;
import static su.nightexpress.sunlight.moduleImpl.homes.HomePlaceholders.HOME_INVITED_PLAYERS;
import static su.nightexpress.sunlight.moduleImpl.homes.HomePlaceholders.HOME_NAME;
import static su.nightexpress.sunlight.moduleImpl.homes.HomePlaceholders.HOME_TYPE;
...
import su.nightexpress.sunlight.moduleImpl.homes.HomesFiles;
        ...
        public void defineDefaultLayout() {
                ...
                this.addDefaultButton("return", MenuItem.button()
                                .defaultState(ItemState.builder()
                                                ...
                                                .action(context -> this.module.openHomes(context.getPlayer(),
                                                                this.getObject(context).getOwner().id()))
                                                .build())
                                .slots(36)
                                .build());
                                ...
                                .defaultState(ItemState.builder()
                                                .icon(NightItem.fromType(Material.NAME_TAG)
                                                                ...
                                                                .setLore(Lists.newList(
                                                                                WHITE.wrap("» ") + GRAY
                                                                                                .wrap("Current: ")
                                                                                                + YELLOW.wrap(HOME_NAME),
                                                                                "",
                                                                                YELLOW.wrap("→ " + UNDERLINED.wrap(
                                                                                                "Click to change")))))
                                                .displayModifier((context, item) -> item
                                                                .replace(builder -> builder.with(this.getObject(context)
                                                                                .placeholders())))
                                                .action(context -> {
                                                        this.plugin.showDialog(context.getPlayer(),
                                                                        HomeDialogKeys.HOME_NAME,
                ...
                this.addDefaultButton("favorite", MenuItem.button()
                                .defaultState(ItemState.builder()
                                                ...
                                                .action(context -> {
                                                        ...
                                                        Home oldFavorite = this.module
                                                                        .getFavoriteHome(context.getPlayer());
                ...
                this.addDefaultButton("invited_players", MenuItem.button()
                                .defaultState(ItemState.builder()
                                                .icon(NightItem.fromType(Material.WRITABLE_BOOK)
                                                                .setDisplayName(ORANGE.and(BOLD)
                                                                                .wrap("Invited Players"))
                                                                .setLore(Lists.newList(
                                                                                WHITE.wrap("» ") + GRAY.wrap(
                                                                                                "Players Invited: ")
                                                                                                + ORANGE.wrap(HOME_INVITED_PLAYERS),
                                                                                "",
                                                                                GRAY.wrap("Share your home with friends!"),
                                                                                "",
                                                                                ORANGE.wrap("→ " + UNDERLINED.wrap(
                                                                                                "Click to edit")))))
                                                .condition(context -> this.getObject(context).isPrivate())
                                                .displayModifier((context, item) -> item
                                                                .replace(builder -> builder.with(this.getObject(context)
                                                                                .placeholders())))
                                                .action(context -> this.module.openInvitedPlayersMenu(
                                                                context.getPlayer(),
                                                                this.getObject(context)))
                                                .build())
                                .slots(25)

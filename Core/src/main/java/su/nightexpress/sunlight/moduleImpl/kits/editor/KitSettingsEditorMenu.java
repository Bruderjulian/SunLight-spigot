package su.nightexpress.sunlight.moduleImpl.kits.editor;
    ...
    public void defineDefaultLayout() {
        ...
        this.addDefaultButton("kit_description", MenuItem.button()
                .defaultState(ItemState.builder()
                        ...
                        .displayModifier((context, item) -> item.replace(builder -> builder.with(this.getObject(context)
                                .placeholders())))
                        .action(context -> {
                            this.plugin.showDialog(context.getPlayer(), KitDialogKeys.KIT_DESCRIPTION,
        ...
        this.addDefaultButton("kit_priority", MenuItem.button()
                .defaultState(ItemState.builder()
                        ...
                        .displayModifier((context, item) -> item.replace(builder -> builder
                                .with(GENERIC_VALUE,
                                        () -> String.valueOf(this.getObject(context).definition().getPriority()))))
                        .action(context -> {
                            this.plugin.showDialog(context.getPlayer(), KitDialogKeys.KIT_PRIORITY,
                                    this.getObject(context),
                                    () -> context.getViewer().refresh());
                        })
                        .build())
        ...
        this.addDefaultButton("kit_permission", MenuItem.button()
                .defaultState(ItemState.builder()
                        ...
                        .displayModifier((context, item) -> item.replace(builder -> builder
                                .with(GENERIC_STATE,
                                        () -> CoreLang.STATE_ENABLED_DISALBED.get(this.getObject(context).definition()
        ...
        this.addDefaultButton("kit_cost", MenuItem.button()
                .defaultState(ItemState.builder()
                        ...
                        .displayModifier((context, item) -> item.replace(builder -> builder
                                .with(GENERIC_VALUE,
                                        () -> NumberUtil.format(this.getObject(context).definition().getCost()))))
                        .action(context -> {
        ...
        this.addDefaultButton("kit_cooldown", MenuItem.button()
                .defaultState(ItemState.builder()
                        ...
                        .displayModifier((context, item) -> item.replace(builder -> builder
                                .with(GENERIC_TIME,
                                        () -> TimeFormats.formatAmount(TimeUnit.SECONDS.toMillis(this.getObject(context)
                                                .definition().getCooldown()), TimeFormatType.LITERAL))))
                        .action(context -> {
                            this.plugin.showDialog(context.getPlayer(), KitDialogKeys.KIT_COOLDOWN,
                                    this.getObject(context),
                                    () -> context.getViewer().refresh());
                        })
                        .build())
        ...
        this.addDefaultButton("commands", MenuItem.button()
                .defaultState(ItemState.builder()
                        ...
                        .displayModifier((context, item) -> item.replace(builder -> builder
                                .with(GENERIC_VALUE,
                                        () -> String.join(BR, this.getObject(context).definition().getCommands()))))
                        .action(context -> {
                            this.plugin.showDialog(context.getPlayer(), KitDialogKeys.KIT_COMMANDS,
                                    this.getObject(context),
                                    () -> context.getViewer().refresh());
                        })
                        .build())

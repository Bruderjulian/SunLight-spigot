...
public class BansPlaceholders extends SLPlaceholders {
        ...
        private static final TypedPlaceholder<AbstractPunishment> PUNISHMENT = TypedPlaceholder
                        .builder(AbstractPunishment.class)
                        ...
                        .with(PUNISHMENT_DURATION,
                                        punishment -> TimeFormats.formatAmount(punishment.getDuration(),
                                                        TimeFormatType.LITERAL))
                        .with(PUNISHMENT_EXPIRES_IN,
                                        punishment -> !punishment.isPermanent()
                                                        ? TimeFormats.formatDuration(punishment.getExpirationDate(),
                                                                        TimeFormatType.LITERAL)
                                                        : CoreLang.OTHER_NEVER.text())
                        .with(PUNISHMENT_CREATION_DATE,
                                        punishment -> TimeFormats.formatDateTime(punishment.getCreationDate()))
                        .with(PUNISHMENT_EXPIRATION_DATE,
                                        punishment -> !punishment.isPermanent()
                                                        ? TimeFormats.formatDateTime(punishment.getExpirationDate())
                                                        : CoreLang.OTHER_NEVER.text())
                        .build();

        public static final TypedPlaceholder<PlayerPunishment> PLAYER_PUNISHMENT = TypedPlaceholder
                        .builder(PlayerPunishment.class)
                        .include(PUNISHMENT)
                        .with(PUNISHMENT_TARGET, PlayerPunishment::getPlayerName)
                        .build();

        public static final TypedPlaceholder<InetPunishment> INET_PUNISHMENT = TypedPlaceholder
                        .builder(InetPunishment.class)
                        .include(PUNISHMENT)

...
public class Config extends AbstractConfig {
    ...
    public static final ConfigValue<String> GENERAL_DATE_FORMAT = ConfigValue.create("General.Date_Format",
            "dd/MM/yyyy HH:mm:ss",
            "Sets the global date format used in various plugin modules.").whenRead(SLUtils::setDateFormatter);

    public static final ConfigValue<String> GENERAL_TIME_FORMAT = ConfigValue.create("General.Time_Format",
            "HH:mm:ss",
            "Sets the global time format used in various plugin modules.").whenRead(SLUtils::setTimeFormatter);

...
public class BackLocationSettings extends AbstractConfig {
    ...
    public final ConfigProperty<Boolean> cacheTeleports = this.addProperty(ConfigTypes.BOOLEAN,
            "Location.Previous.Enabled",
            true,
    ...
    public final ConfigProperty<Integer> teleportCacheExpireTime = this.addProperty(ConfigTypes.INT,
            "Location.Previous.Expire_Time",
            3600,
            "Sets cache time (in seconds) for pre-teleport locations.");

    public final ConfigProperty<Integer> teleportMinDistanceDifference = this.addProperty(ConfigTypes.INT,
            "Location.Previous.Min_Distance_Difference",
            10,
    ...
    public final ConfigProperty<Set<String>> teleportWorldBlacklist = this.addProperty(ConfigTypes.STRING_SET,
    ...
    public final ConfigProperty<Boolean> resetDeathCacheOnUse = this.addProperty(ConfigTypes.BOOLEAN,
            "Location.Death.ResetOnUse",
            true,
            "Controls whether players can teleport to their death location only once per death.");

    public final ConfigProperty<Integer> deathCacheExpireTime = this.addProperty(ConfigTypes.INT,
            "Location.Death.Expire_Time",
            3600,
            "Sets cache time (in seconds) for death locations.");

    public final ConfigProperty<Set<String>> deathWorldBlacklist = this.addProperty(ConfigTypes.STRING_SET,

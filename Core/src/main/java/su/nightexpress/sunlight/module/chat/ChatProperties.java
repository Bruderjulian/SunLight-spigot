...
public class ChatProperties {
        ...
        public static final UserProperty<Boolean> SOCIAL_SPY_INFO = UserProperty.create("spy_chat_social",
                        Boolean.class,
                        false, true);
        public static final UserProperty<Boolean> SOCIAL_SPY_LOG = UserProperty.create("spy_log_social", Boolean.class,
                        false, true);
        public static final UserProperty<Boolean> COMMAND_SPY_INFO = UserProperty.create("spy_chat_command",
                        Boolean.class,
                        false, true);
        public static final UserProperty<Boolean> COMMAND_SPY_LOG = UserProperty.create("spy_log_command",
                        Boolean.class,
                        false, true);
        public static final UserProperty<Boolean> CHAT_SPY_INFO = UserProperty.create("spy_chat_chat", Boolean.class,
                        false,
                        true);
        public static final UserProperty<Boolean> CHAT_SPY_LOG = UserProperty.create("spy_log_chat", Boolean.class,
                        false,
                        true);

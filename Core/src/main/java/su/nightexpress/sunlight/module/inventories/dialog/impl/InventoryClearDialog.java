...
public class InventoryClearDialog extends Dialog<InventoryClearDialog.ClearRequest> {
    ...
    private static final TextLocale TITLE = LangEntry.builder("Inventories.Dialog.Clear.Title").text(title("Inventory",
        "Clear"));

    private static final DialogElementLocale BODY_INVENTORY = LangEntry.builder("Inventories.Dialog.Clear.Body.Inventory").dialogElement(400,
        "Are you sure you want to clear your inventory?",
        "",
        TagWrappers.SOFT_RED.wrap("This action cannot be undone!")
    );

    private static final DialogElementLocale BODY_ENDER_CHEST = LangEntry.builder("Inventories.Dialog.Clear.Body.EnderChest").dialogElement(400,

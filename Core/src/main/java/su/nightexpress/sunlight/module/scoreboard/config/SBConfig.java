...
public class SBConfig extends AbstractConfig {
    ...
    private final ConfigProperty<Map<String, BoardDefinition>> boardDefinitions = this.addProperty(
            ConfigTypes.forMapWithLowerKeys(BOARD_DEFINITION_CONFIG_TYPE),
            "Boards",
            ...
            "          - %s - include dynamic text (animation) from the '%s'."
                    .formatted(SLPlaceholders.ANIMATION.apply("[name]"), ScoreboardDefaults.FILE_ANIMATIONS),

...
public class ExperienceCommandsProvider extends AbstractCommandProvider {
    ...
    private static final TextLocale DESCRIPTION_LEVEL_SET = LangEntry.builder("Command.Experience.SetLevel.Desc")
            .text("Set XP levels.");
    private static final TextLocale DESCRIPTION_LEVEL_REMOVE = LangEntry.builder("Command.Experience.RemoveLevel.Desc")
    ...
    private static final MessageLocale MESSAGE_XP_SET_FEEDBACK = LangEntry.builder("Command.Experience.SetXP.Feedback")
            .chatMessage(
                    Sound.ENTITY_EXPERIENCE_ORB_PICKUP,
                    GRAY.wrap("You have set " + WHITE.wrap(PLAYER_DISPLAY_NAME) + "'s total XP to "
                            + SOFT_YELLOW.wrap(GENERIC_VALUE) + " (" + YELLOW.wrap(GENERIC_OLD_VALUE)
    ...
    private static final MessageLocale MESSAGE_XP_ADD_FEEDBACK = LangEntry.builder("Command.Experience.AddXP.Feedback")
            .chatMessage(
                    Sound.ENTITY_EXPERIENCE_ORB_PICKUP,
                    GRAY.wrap("You have added " + SOFT_GREEN.wrap(GENERIC_VALUE) + " XP to "
                            + WHITE.wrap(PLAYER_DISPLAY_NAME) + " (" + YELLOW.wrap(GENERIC_OLD_VALUE)
                            + DARK_GRAY.wrap(" → ") + GREEN.wrap(GENERIC_NEW_VALUE) + ")"));
    ...
    private static final MessageLocale MESSAGE_LEVEL_SET_FEEDBACK = LangEntry
            .builder("Command.Experience.SetLevel.Feedback").chatMessage(
    ...
    private static final MessageLocale MESSAGE_LEVEL_SET_NOTIFY = LangEntry
            .builder("Command.Experience.SetLevel.Notify").chatMessage(
                    Sound.ENTITY_PLAYER_LEVELUP,
    ...
    private static final MessageLocale MESSAGE_LEVEL_ADD_FEEDBACK = LangEntry
            .builder("Command.Experience.AddLevel.Feedback").chatMessage(
                    Sound.ENTITY_PLAYER_LEVELUP,
    ...
    private static final MessageLocale MESSAGE_LEVEL_ADD_NOTIFY = LangEntry
            .builder("Command.Experience.AddLevel.Notify").chatMessage(
                    Sound.ENTITY_PLAYER_LEVELUP,
    ...
    private static final MessageLocale MESSAGE_LEVEL_REMOVE_FEEDBACK = LangEntry
            .builder("Command.Experience.RemoveLevel.Feedback").chatMessage(
                    Sound.ENTITY_PLAYER_LEVELUP,
    ...
    private static final MessageLocale MESSAGE_LEVEL_REMOVE_NOTIFY = LangEntry
            .builder("Command.Experience.RemoveLevel.Notify").chatMessage(
                    Sound.ENTITY_PLAYER_LEVELUP,
    ...
    public ExperienceCommandsProvider(SunLightPlugin plugin, EssentialModule module, UserManager userManager) {
        super(plugin);
        this.module = module;
    ...
    private void buildLevelCommand(LiteralNodeBuilder builder, TextLocale description, ModifyMode mode) {
        builder
    ...
    private void buildXPCommand(LiteralNodeBuilder builder, TextLocale description, ModifyMode mode) {
        builder
                .description(description)
    ...
    private boolean changeXP(CommandContext context, ParsedArguments arguments, ModifyMode mode) {
    ...
    private boolean changeLevels(CommandContext context, ParsedArguments arguments, ModifyMode mode) {
        return this.loadPlayerOrSenderAndRunInMainThread(context, arguments, this.module, this.userManager, target -> {
            int amount = arguments.getInt(CommandArguments.AMOUNT);

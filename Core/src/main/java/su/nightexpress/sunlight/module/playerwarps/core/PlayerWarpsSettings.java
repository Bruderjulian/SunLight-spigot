...
public class PlayerWarpsSettings extends AbstractConfig {
    ...
    private final ConfigProperty<Set<String>> warpsWorldBlacklist = this.addProperty(ConfigTypes.STRING_SET_LOWER_CASE,
    ...
    private static Map<String, FeaturedSlot> getDefaultPromotionSlots() {
        return Map.of(
                "left",
                new FeaturedSlot("left", CurrencyId.VAULT, 1000, TimeUnit.SECONDS.convert(7, TimeUnit.DAYS),
                        new int[] { 1, 2 }),
                "right", new FeaturedSlot("right", CurrencyId.VAULT, 1000, TimeUnit.SECONDS.convert(7, TimeUnit.DAYS),
                        new int[] { 6, 7 }));
    }
    ...
    private static Map<String, NormalCategory> getDefaultCategories() {
        ...
        NormalCategory category0 = new NormalCategory("default", "Default", true,
                Lists.newList(TagWrappers.GRAY.wrap("All other warps.")), NightItem.fromType(Material.COMPASS));
        ...
        NormalCategory category2 = new NormalCategory("farms", "Farms", false,
                Lists.newList(TagWrappers.GRAY.wrap("Farm mobs and items.")), NightItem.fromType(Material.CARROT));

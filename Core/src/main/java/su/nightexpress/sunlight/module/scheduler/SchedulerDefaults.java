...
public class SchedulerDefaults {
    ...
    public static Map<String, Announcer> getDefaultAnnouncers() {
        ...
        texts.put("discord", List.of(
                ...
                DARK_GRAY.wrap(BOLD.wrap("|")) + " "
                        + GRAY.wrap(BLUE.wrap("giveaways") + ", " + BLUE.wrap("events") + " and much more!"),
                " ",
        ...
        texts.put("store", List.of(
                ...
                DARK_GRAY.wrap(BOLD.wrap("|")) + " "
                        + GRAY.wrap("Obtain " + ORANGE.wrap("crate keys") + " for an opportunity to"),
                DARK_GRAY.wrap(BOLD.wrap("|")) + " "
                        + GRAY.wrap("acquire " + ORANGE.wrap("exciting rewards") + " within the game."),
                " ",

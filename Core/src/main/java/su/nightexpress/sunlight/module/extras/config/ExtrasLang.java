...
public class ExtrasLang implements LangContainer {
    ...
    public static final TextLocale COMMAND_GOD_DESC = LangEntry.builder("Extras.Command.God.Desc").text("Toggle God Mode.");
    ...
    public static final MessageLocale COMMAND_GOD_NOTIFY = LangEntry.builder("Extras.Command.God.Notify").chatMessage(
        LIGHT_GRAY.wrap("Set " + LIGHT_YELLOW.wrap("God Mode") + " on " + LIGHT_YELLOW.wrap(GENERIC_STATE) + ".")
    );

    public static final MessageLocale COMMAND_GOD_TARGET = LangEntry.builder("Extras.Command.God.Target").chatMessage(
        LIGHT_GRAY.wrap("Set " + LIGHT_YELLOW.wrap(PLAYER_DISPLAY_NAME) + "'s " + LIGHT_YELLOW.wrap("God Mode") + " on " + LIGHT_YELLOW.wrap(GENERIC_STATE) + ".")
    );

...
public class TabDefaults {
    ...
    public static Map<String, TabNameFormat> getDefaultListNameFormats() {
        ...
        map.put("default", new TabNameFormat(1, Set.of(SLPlaceholders.WILDCARD),
                AQUA.wrap("[Member]") + " " + GRAY.wrap(PLAYER_DISPLAY_NAME) + PLACEHOLDER_AFK));
        map.put("admin", new TabNameFormat(100, Set.of("admin"),
                RED.wrap("[Admin]") + " " + GRAY.wrap(PLAYER_DISPLAY_NAME) + PLACEHOLDER_AFK));
        map.put("owner", new TabNameFormat(10_000, Set.of("owner"),
                PURPLE.wrap("[Owner]") + " " + GRAY.wrap(PLAYER_DISPLAY_NAME) + PLACEHOLDER_AFK));
    ...
    public static List<DynamicText> getDefaultAnimations() {
        ...
        list.add(new DynamicText(DEF_ANIMATION_1, Lists.newList(
                DARK_GRAY.wrap(" ".repeat(16) + BLUE.wrap(UNDERLINED.wrap("[Discord]")) + " [Store] [Website]"
                        + " ".repeat(16)),
                DARK_GRAY.wrap(" ".repeat(16) + "[Discord] " + GREEN.wrap(UNDERLINED.wrap("[Store]")) + " [Website]"
                        + " ".repeat(16)),
                DARK_GRAY.wrap(" ".repeat(16) + "[Discord] [Store] " + ORANGE.wrap(UNDERLINED.wrap("[Website]"))
                        + " ".repeat(16))),
                5000));
        ...
        list.add(new DynamicText(DEF_ANIMATION_2, Lists.newList(
                ...
                GRAY.wrap(" ".repeat(16) + "Learn first about new updates at our site:" + " ".repeat(16))), 5000));
        ...
        list.add(new DynamicText(DEF_ANIMATION_3, Lists.newList(
                ...
                GRAY.wrap(" ".repeat(16) + ORANGE.wrap("www.mysupercraft.com") + " ".repeat(16))), 5000));

...
public class MailDataManager {
    ...
    public MailDataManager(@NotNull DataHandler dataHandler) {
    ...
    @NotNull
    public List<MailData> getMails(@NotNull UUID recipientId) {
    ...
    public void insertMail(@NotNull MailData mail) {
        this.dataHandler.insert(this.mailsTable, MailQueries.INSERT_MAIL, mail);
    }

    public void deleteMails(@NotNull UUID recipientId) {

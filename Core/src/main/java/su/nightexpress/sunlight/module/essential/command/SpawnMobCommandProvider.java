...
public class SpawnMobCommandProvider extends AbstractCommandProvider {
    ...
    public SpawnMobCommandProvider(SunLightPlugin plugin) {
        super(plugin);
    }
        ...
        this.registerLiteral("spawnmob", true, new String[] { "spawnmob" }, builder -> builder
                ...
                .withArguments(
                        ...
                        Arguments.integer(CommandArguments.AMOUNT, 1)
                                ...
                                .suggestions((reader, tabContext) -> IntStream.range(1, this.spawnLimit).boxed()
                                        .map(String::valueOf).toList()))
                .executes(this::spawnMob));
    }

    private boolean spawnMob(CommandContext context, ParsedArguments arguments) {

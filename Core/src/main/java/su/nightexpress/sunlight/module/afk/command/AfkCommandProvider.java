...
public class AfkCommandProvider extends AbstractCommandProvider {
    ...
    public void registerDefaults() {
         ...
         * ),
         * builder ->
         * builder.description(AfkLang.COMMAND_AFK_ROOT_DESC).permission(AfkPerms.
         * COMMAND_AFK)
         * );
         */
    }
    ...
    private void buildCommand(LiteralNodeBuilder builder, ToggleMode mode) {
        ...
        builder
                ...
                .withArguments(
                        Arguments.player(CommandArguments.PLAYER).optional().permission(AfkPerms.COMMAND_AFK_OTHERS))

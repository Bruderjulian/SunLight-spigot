...
public class EnchantCommandsProvider extends AbstractCommandProvider {
        ...
        public EnchantCommandsProvider(SunLightPlugin plugin, EssentialModule module, UserManager userManager) {
                super(plugin);
                this.module = module;
        ...
        public void registerDefaults() {
                ...
                this.registerLiteral("disenchant", true, new String[] { "disenchant" }, builder -> builder
                                ...
                                .withArguments(
                                                ...
                                                Arguments.playerName(CommandArguments.PLAYER).optional()
                                                                .permission(PERMISSION_DISENCHANT_OTHERS))
                                .withFlags(CommandArguments.FLAG_SILENT)
                                .executes(this::disenchantSlot));
        }

        private boolean enchantSlot(CommandContext context, ParsedArguments arguments) {
                return this.loadPlayerOrSenderAndRunInMainThread(context, arguments, this.module, this.userManager,
                                target -> {
                                        ...
                                        if (item.getType().isAir() || item.getItemMeta() == null) {
                                                this.module.sendPrefixed(MESSAGE_ERROR_NO_ITEM, context.getSender(),
                                                                replacer -> replacer
                                                ...
                                                this.module.sendPrefixed(MESSAGE_ENCHANTED_FEEDBACK,
                                                                context.getSender(), replacer -> replacer
                                                                                ...
                                                                                .with(SLPlaceholders.GENERIC_AMOUNT,
                                                                                                () -> LangUtil.getEnchantmentLevelLang(
                                                                                                                level)));
                                        }

                                        if (!context.hasFlag(CommandArguments.FLAG_SILENT)) {
                                                this.module.sendPrefixed(MESSAGE_ENCHANTED_NOTIFY, target,
                                                                replacer -> replacer
                                                                                .with(SLPlaceholders.GENERIC_TYPE,
                                                                                                () -> Lang.EQUIPMENT_SLOT
                                                                                                                .getLocalized(slot))
        ...
        private boolean disenchantSlot(CommandContext context, ParsedArguments arguments) {
                return this.loadPlayerOrSenderAndRunInMainThread(context, arguments, this.module, this.userManager,
                                target -> {
                                        EquipmentSlot slot = arguments.get(ARG_SLOT, EquipmentSlot.class);
                                        ...
                                        ItemMeta meta = item.getItemMeta();
                                        Enchantment enchant = arguments.contains(ARG_ENCHANT)
                                                        ? arguments.getEnchantment(ARG_ENCHANT)
                                                        : null;
                                        boolean hasEnchant = enchant != null;

                                        if (hasEnchant) {
                                                boolean isEnchanted = (meta instanceof EnchantmentStorageMeta storageMeta
                                                                && storageMeta
                                                                                .hasStoredEnchant(enchant)
                                                                || meta.hasEnchant(enchant));
                                                if (!isEnchanted) {
                                                        this.module.sendPrefixed(MESSAGE_ERROR_NO_ENCHANT,
                                                                        context.getSender(), replacer -> replacer
                                                                                        .with(CommonPlaceholders.PLAYER
                                                                                                        .resolver(target))
                                                                                        .with(GENERIC_ITEM,
                                        ...
                                        if (target != context.getSender()) {
                                                this.module.sendPrefixed(
                                                                (hasEnchant ? MESSAGE_DISENCHANTED_SPECIFIC_FEEDBACK
                                                                                : MESSAGE_DISENCHANTED_ALL_FEEDBACK),
                                                                context
                                                                                .getSender(),
                                                                replacer -> replacer
                                                                                .with(CommonPlaceholders.PLAYER
                                        ...
                                        if (!context.hasFlag(CommandArguments.FLAG_SILENT)) {
                                                this.module.sendPrefixed(
                                                                hasEnchant ? MESSAGE_DISENCHANTED_SPECIFIC_NOTIFY
                                                                                : MESSAGE_DISENCHANTED_ALL_NOTIFY,
                                                                target,
                                                                replacer -> replacer
                                                                                .with(GENERIC_SLOT,
                                                                                                () -> Lang.EQUIPMENT_SLOT

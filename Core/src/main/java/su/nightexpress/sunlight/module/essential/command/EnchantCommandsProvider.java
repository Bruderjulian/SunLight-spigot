...
public class EnchantCommandsProvider extends AbstractCommandProvider {
    ...
    private static final MessageLocale MESSAGE_ERROR_NO_ENCHANT = LangEntry.builder("Command.Disenchant.NotEnchanted")
            .chatMessage(
                    GRAY.wrap("The " + SOFT_RED.wrap(GENERIC_ITEM) + " item in the " + WHITE.wrap(PLAYER_DISPLAY_NAME)
                            + "'s " +
        ...
        this.registerLiteral("enchant", true, new String[] { "enchant" }, builder -> builder
                ...
                .withArguments(
                        ...
                        Arguments.integer(ARG_LEVEL, 1)
                                .suggestions((reader, context) -> Lists.newList("0", "1", "5", "10",
                                        "127"))
                                .optional(),
                ...
                this.module.sendPrefixed(
                        ...
                        replacer -> replacer
                                ...
                                .with(GENERIC_ENCHANTMENT,
                                        () -> hasEnchant ? LangUtil.getSerializedName(enchant) : ""));
            }
